...
class InfiniteTimeoutWorker(Worker):
    ...
    def init_tools(self):
        ...
        # GEORGE:debugging
        # als and inv string values
        #print('\nals_string: ' + als_string)
        ...
        # GEORGE:debugging
        # check values of stuff from generate_artifacts()
        #print('\n --GENERATED ARTIFACTS--')
        #print('cnf: ' + str(self.cnf))
        #print('cnf_inv: ' + str(self.cnf_inv))
    ...
    def main_loop_busy(self):
        ...
        if self.current_tool.finished():
            ...
            elapsed = andrea.network.time() - self.tool_start_time
            (tid, ttype, tdata, infinite_timeout, curMax, level, timeout) = self.current_task
            #print("Debug-mfrias4, worker.py line 172, main_loop_busy. elapsed = ", elapsed, "Infinite TO = ", infinite_timeout, "self.timeout = ", self.timeout, "self.current_tool = ", self.current_tool, " I am worker ", self.my_rank, " self.proc_inv = ", self.proc_inv)
    ...
    def handler_res(self, tid, tdata):
        ...
        # GEORGE:debugging
        # lets check the logic where it messes up
        ...
        if self.proc_inv == True: 
            ...
            # GEORGE:debugging
            # is the cnf_inv valid?
            #print('CNF_INV VAL: ' + str(self.cnf_inv) + '\n')
