...
class Worker(Process):
    ...
    def main_loop_busy(self):
        ...
        if self.current_tool.finished():
            ...
            print("Debug-mfrias4, andrea.worker.py line 133, tool not yet finished. Elapsed time = ", network.time() - self.tool_start_time, " TO = ", self.timeout)
    ...
    def handle_mission_als(self, tid, spec_contents):
        ...
        print("debugging als_path = " + als_path)
    ...
    def handle_mission_cnf(self, tid, dimacs_contents):
        ...
        print("debugging cnf_path = " + cnf_path)
