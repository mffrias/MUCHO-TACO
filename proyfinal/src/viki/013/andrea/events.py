...
class TaskEvent(Event):
    ...
    def __str__(self):
        ...
        #:q
        #print("Debug-mfrias4, events.py line 71. TaskEvent toString. self.etc = ", self.etc)
        ...
        if 'solver.msecs' in self.stats:
            ...
            #print("Debug-mfrias4, events.py line 80. solver_time = ", solver_time, " floatingseconds = ", floatingseconds, "pv = ", self.stats.get('cnf.privars'))
