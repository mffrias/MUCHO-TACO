...
class Master(Process):
    ...
    def start(self):
        ...
        self.tasklog_file.write('#task_id,task_type,worker_rank,max,level,outcome,rc_num,rc_str,tot_msec_solv,tot_msec_task\n')
    ...
    def handle_message(self, msg):
        if isinstance(msg, WantMission):
            ...
            tid, ttype, curMax, level, infto, timeout, tres, tecode, testr, tstatdict = msg.body
            self.mission_finished(msg.src, tid, ttype, curMax, level, infto, timeout, tres, tecode, testr, tstatdict)
        else:
    ...
    def mission_finished(self, worker, tid, ttype, timeout, curMax, level, tres, tecode, testr, tstats):
        ...
        row = [tid, ttype, worker, curMax, level, tres, tecode, testr, tt_solv, tt_task]
